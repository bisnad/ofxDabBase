...
public:
    ...
    virtual const AbstractParameter& operator=( const AbstractParameter& pParameter ) throw (dab::Exception) = 0;
    ...
    AbstractValue& value() throw (dab::Exception);
    const AbstractValue& value() const throw (dab::Exception);
    
    template<typename DataType> DataType& value() throw (dab::Exception);
    template<typename DataType> DataType& minValue() throw (dab::Exception);
    template<typename DataType> DataType& maxValue() throw (dab::Exception);
    template<typename DataType> std::vector< DataType& > valueOptions() throw (dab::Exception);
    
    template<typename DataType> const DataType& value() const throw (dab::Exception);
    template<typename DataType> const DataType& minValue() const throw (dab::Exception);
    template<typename DataType> const DataType& maxValue() const throw (dab::Exception);
    template<typename DataType> std::vector< const DataType& > valueOptions() const throw (dab::Exception);
    
    void setName( const std::string& pName );
    template<typename DataType > void setValue( const DataType& pValue ) throw (dab::Exception);
    template<typename DataType > void setMinValue( const DataType& pMinValue ) throw (dab::Exception);
    template<typename DataType > void setMaxValue( const DataType& pMaxValue ) throw (dab::Exception);
...
public:
    ...
    const AbstractParameter& operator=( const AbstractParameter& pParameter ) throw (dab::Exception);
    const Parameter& operator=( const Parameter& pParameter );
    AbstractParameter* copy() const;
    
    DataType& value() throw (dab::Exception);
    DataType& minValue() throw (dab::Exception);
    DataType& maxValue() throw (dab::Exception);
    std::vector< DataType& > valueOptions() throw (dab::Exception);
    
    const DataType& value() const throw (dab::Exception);
    const DataType& minValue() const throw (dab::Exception);
    const DataType& maxValue() const throw (dab::Exception);
    std::vector< const DataType& > valueOptions() const throw (dab::Exception);
    
    void setValue( const DataType& pValue ) throw (dab::Exception);
    void setMinValue( const DataType& pMinValue ) throw (dab::Exception);
    void setMaxValue( const DataType& pMaxValue ) throw (dab::Exception);
...
public:
    ...
    std::array<DataType, DataDim>& value() throw (dab::Exception);
    std::array<DataType, DataDim>& minValue() throw (dab::Exception);
    std::array<DataType, DataDim>& maxValue() throw (dab::Exception);
    std::vector< std::array<DataType, DataDim>& > valueOptions() throw (dab::Exception);
    
    const std::array<DataType, DataDim>& value() const throw (dab::Exception);
    const std::array<DataType, DataDim>& minValue() const throw (dab::Exception);
    const std::array<DataType, DataDim>& maxValue() const throw (dab::Exception);
    std::vector< const std::array<DataType, DataDim>& > valueOptions() const throw (dab::Exception);
    
    void setValue( const std::array<DataType, DataDim>& pValue ) throw (dab::Exception);
    void setMinValue( const std::array<DataType, DataDim>& pMinValue ) throw (dab::Exception);
    void setMaxValue( const std::array<DataType, DataDim>& pMaxValue ) throw (dab::Exception);
...
template<typename DataType>
DataType&
AbstractParameter::value() throw (dab::Exception)
{
...
template<typename DataType>
DataType&
AbstractParameter::minValue() throw (dab::Exception)
{
...
template<typename DataType>
DataType&
AbstractParameter::maxValue() throw (dab::Exception)
{
...
template<typename DataType>
std::vector< DataType& >
AbstractParameter::valueOptions() throw (dab::Exception)
{
...
template<typename DataType>
const DataType&
AbstractParameter::value() const throw (dab::Exception)
{
    if( mValue == nullptr ) throw dab::Exception("DATA ERROR: parameter has no value", __FILE__,__FUNCTION__, __LINE__);
...
template<typename DataType>
const DataType&
AbstractParameter::minValue() const throw (dab::Exception)
{
    if( mMinValue == nullptr ) throw dab::Exception("DATA ERROR: parameter has no minimum value", __FILE__,__FUNCTION__, __LINE__);
...
template<typename DataType>
const DataType&
AbstractParameter::maxValue() const throw (dab::Exception)
{
    if( mMaxValue == nullptr ) throw dab::Exception("DATA ERROR: parameter has no maximum value", __FILE__,__FUNCTION__, __LINE__);
...
AbstractParameter::valueOptions() const throw (dab::Exception)
{
    if( mValueOptions.size() == 0 ) throw dab::Exception("DATA ERROR: parameter has no value options", __FILE__,__FUNCTION__, __LINE__);
...
template<typename DataType >
void
AbstractParameter::setValue( const DataType& pValue ) throw (dab::Exception)
{
    if( mValue == nullptr ) throw dab::Exception("DATA ERROR: parameter has no value", __FILE__,__FUNCTION__, __LINE__);
...
template<typename DataType >
void
AbstractParameter::setMinValue( const DataType& pMinValue ) throw (dab::Exception)
{
    if( mMinValue == nullptr ) throw dab::Exception("DATA ERROR: parameter has no minimum value", __FILE__,__FUNCTION__, __LINE__);
...
template<typename DataType >
void
AbstractParameter::setMaxValue( const DataType& pMaxValue ) throw (dab::Exception)
{
    if( mMaxValue == nullptr ) throw dab::Exception("DATA ERROR: parameter has no maximum value", __FILE__,__FUNCTION__, __LINE__);
...
Parameter<DataType>::operator=( const AbstractParameter& pParameter ) throw (dab::Exception)
{
...
template <typename DataType>
DataType&
Parameter<DataType>::value() throw (dab::Exception)
{
    if( mValue == nullptr ) throw dab::Exception("DATA ERROR: parameter has no value", __FILE__,__FUNCTION__, __LINE__);
...
template <typename DataType>
DataType&
Parameter<DataType>::minValue() throw (dab::Exception)
{
    if( mMinValue == nullptr ) throw dab::Exception("DATA ERROR: parameter has no minimum value", __FILE__,__FUNCTION__, __LINE__);
...
template <typename DataType>
DataType&
Parameter<DataType>::maxValue() throw (dab::Exception)
{
    if( mMaxValue == nullptr ) throw dab::Exception("DATA ERROR: parameter has no maximum value", __FILE__,__FUNCTION__, __LINE__);
...
template <typename DataType>
std::vector< DataType& >
Parameter<DataType>::valueOptions() throw (dab::Exception)
{
    if( mValueOptions.size() == 0 ) throw dab::Exception("DATA ERROR: parameter has no value options", __FILE__,__FUNCTION__, __LINE__);
...
template <typename DataType>
const DataType&
Parameter<DataType>::value() const throw (dab::Exception)
{
    if( mValue == nullptr ) throw dab::Exception("DATA ERROR: parameter has no value", __FILE__,__FUNCTION__, __LINE__);
...
template <typename DataType>
const DataType&
Parameter<DataType>::minValue() const throw (dab::Exception)
{
    if( mMinValue == nullptr ) throw dab::Exception("DATA ERROR: parameter has no minimum value", __FILE__,__FUNCTION__, __LINE__);
...
template <typename DataType>
const DataType&
Parameter<DataType>::maxValue() const throw (dab::Exception)
{
    if( mMaxValue == nullptr ) throw dab::Exception("DATA ERROR: parameter has no maximum value", __FILE__,__FUNCTION__, __LINE__);
...
template <typename DataType>
std::vector< const DataType& >
Parameter<DataType>::valueOptions() const throw (dab::Exception)
{
    if( mValueOptions.size() == 0 ) throw dab::Exception("DATA ERROR: parameter has no value options", __FILE__,__FUNCTION__, __LINE__);
...
template <typename DataType>
void
Parameter<DataType>::setValue( const DataType& pValue ) throw (dab::Exception)
{
    if( mValue == nullptr ) throw dab::Exception("DATA ERROR: parameter has no value", __FILE__,__FUNCTION__, __LINE__);
...
template <typename DataType>
void
Parameter<DataType>::setMinValue( const DataType& pMinValue ) throw (dab::Exception)
{
    if( mMinValue == nullptr ) throw dab::Exception("DATA ERROR: parameter has no minimum value", __FILE__,__FUNCTION__, __LINE__);
...
template <typename DataType>
void
Parameter<DataType>::setMaxValue( const DataType& pMaxValue ) throw (dab::Exception)
{
    if( mMaxValue == nullptr ) throw dab::Exception("DATA ERROR: parameter has no maximum value", __FILE__,__FUNCTION__, __LINE__);
...
template <typename DataType, int DataDim>
const AbstractParameter&
Parameter< std::array<DataType, DataDim> >::operator=( const AbstractParameter& pParameter ) throw (dab::Exception)
{
    if( dynamic_cast< const Parameter<DataType>* >(&pParameter) == nullptr ) throw dab::Exception( "DATA ERROR: incompatible data type", __FILE__, __FUNCTION__, __LINE__ );
...
Parameter< std::array<DataType, DataDim> >::value() throw (dab::Exception)
{
    if( mValue == nullptr ) throw dab::Exception("DATA ERROR: parameter has no value", __FILE__,__FUNCTION__, __LINE__);
...
template <typename DataType, int DataDim>
std::array<DataType, DataDim>&
Parameter< std::array<DataType, DataDim> >::minValue() throw (dab::Exception)
{
    if( mMinValue == nullptr ) throw dab::Exception("DATA ERROR: parameter has no minimum value", __FILE__,__FUNCTION__, __LINE__);
...
template <typename DataType, int DataDim>
std::array<DataType, DataDim>&
Parameter< std::array<DataType, DataDim> >::maxValue() throw (dab::Exception)
{
    if( mMaxValue == nullptr ) throw dab::Exception("DATA ERROR: parameter has no maximum value", __FILE__,__FUNCTION__, __LINE__);
...
Parameter< std::array<DataType, DataDim> >::valueOptions() throw (dab::Exception)
{
    if( mValueOptions.size() == 0 ) throw dab::Exception("DATA ERROR: parameter has no value options", __FILE__,__FUNCTION__, __LINE__);
...
Parameter< std::array<DataType, DataDim> >::value() const throw (dab::Exception)
{
    if( mValue == nullptr ) throw dab::Exception("DATA ERROR: parameter has no value", __FILE__,__FUNCTION__, __LINE__);
...
template <typename DataType, int DataDim>
const std::array<DataType, DataDim>&
Parameter< std::array<DataType, DataDim> >::minValue() const throw (dab::Exception)
{
    if( mMinValue == nullptr ) throw dab::Exception("DATA ERROR: parameter has no minimum value", __FILE__,__FUNCTION__, __LINE__);
...
template <typename DataType, int DataDim>
const std::array<DataType, DataDim>&
Parameter< std::array<DataType, DataDim> >::maxValue() const throw (dab::Exception)
{
    if( mMaxValue == nullptr ) throw dab::Exception("DATA ERROR: parameter has no maximum value", __FILE__,__FUNCTION__, __LINE__);
...
Parameter< std::array<DataType, DataDim> >::valueOptions() const throw (dab::Exception)
{
    if( mValueOptions.size() == 0 ) throw dab::Exception("DATA ERROR: parameter has no value options", __FILE__,__FUNCTION__, __LINE__);
...
//void
//Parameter< std::array<std::string, DataDim> >::setValue( const std::array<std::string, DataDim>& pValue ) throw (dab::Exception);

template <typename DataType, int DataDim>
void
Parameter< std::array<DataType, DataDim> >::setValue( const std::array<DataType, DataDim>& pValue ) throw (dab::Exception)
{
    if( mValue == nullptr ) throw dab::Exception("DATA ERROR: parameter has no value", __FILE__,__FUNCTION__, __LINE__);
...
template <typename DataType, int DataDim>
void
Parameter< std::array<DataType, DataDim> >::setMinValue( const std::array<DataType, DataDim>& pMinValue ) throw (dab::Exception)
{
    if( mMinValue == nullptr ) throw dab::Exception("DATA ERROR: parameter has no minimum value", __FILE__,__FUNCTION__, __LINE__);
...
template <typename DataType, int DataDim>
void
Parameter< std::array<DataType, DataDim> >::setMaxValue( const std::array<DataType, DataDim>& pMaxValue ) throw (dab::Exception)
{
    if( mMaxValue == nullptr ) throw dab::Exception("DATA ERROR: parameter has no maximum value", __FILE__,__FUNCTION__, __LINE__);
