...
#pragma mark Array definition
    ...
    public:
        ...
        const _Array& operator=( const _Array& pArray ) throw (Exception);
        ...
        Type& operator[]( unsigned int pIndex ) throw (Exception);
        const Type& operator[]( unsigned int pIndex ) const throw (Exception);
...
#pragma mark Array implementation
    ...
    template<typename Type>
    const _Array&
    Array<Type>::operator=( const _Array& pArray ) throw (Exception)
    {
    ...
    template<typename Type>
    Type&
    Array<Type>::operator[]( unsigned int pIndex ) throw (Exception)
    {
    ...
    template<typename Type>
    const Type&
    Array<Type>::operator[]( unsigned int pIndex ) const throw (Exception)
    {
        if( pIndex >= mSize ) throw Exception( "Data Error: index " + std::to_string(pIndex) + " exceeds array size " + std::to_string(mSize), __FILE__, __FUNCTION__, __LINE__ );
