...
public:
     ...
     */
	unsigned int index(KeyType pKey) const throw (Exception);
     ...
     */
	inline const KeyType& key(unsigned int pIndex) const throw (Exception);
	...
	/**
     ...
     \exception Exception index out of range
     */
	inline const ValueType& value(unsigned int pIndex) const throw (Exception);
	...
	/**
     ...
     \exception Exception index out of range
     */
	inline ValueType& value(unsigned int pIndex) throw (Exception);
    ...
    /**
     ...
     \exception Exception index out of range
     */
	inline const ValueType& operator[] (unsigned int pIndex) const throw (Exception);
	...
	/**
     ...
     \exception Exception index out of range
     */
	inline ValueType& operator[] (unsigned int pIndex) throw (Exception);
	...
	/**
     ...
     \exception Exception key not found
     */
	inline const ValueType& operator[] (const KeyType& pKey) const throw (Exception);
	...
	/**
     ...
     \exception Exception key not found
     */
	inline ValueType& operator[] (const KeyType& pKey) throw (Exception);
     ...
     */
	void add(const KeyType& pKey, const ValueType& pValue) throw (Exception);
	...
	/**
     ...
     same as add
     */
	void insert(const KeyType& pKey, const ValueType& pValue) throw (Exception);
	...
	/**
	 ...
	 \exception Exception key alreay stored
	 */
	void insert(const KeyType& pKey, const ValueType& pValue, unsigned int pIndex ) throw (Exception);
	 ...
	 */
	void move( unsigned int pFromIndex, unsigned int pToIndex ) throw (Exception);
	...
	/**
     ...
     \exception Exception key not found
     */
	void replace(const KeyType& pKey, const ValueType& pValue) throw (Exception);
	...
	/**
     ...
     \exception Exception index out of range
     */
	void replace(unsigned int pIndex, const ValueType& pValue) throw (Exception);
     ...
     */
	void set(const KeyType& pKey, const ValueType& pValue) throw (Exception);
	...
	/**
     ...
     \exception Exception index out of range
     */
	void set(unsigned int pIndex, const ValueType& pValue) throw (Exception);
	...
	/**
     ...
     \exception Exception key not found
     */
	void remove(const KeyType& pKey) throw (Exception);
	...
	/**
     ...
     \exception Exception index out of range
     */
	void remove(unsigned int pIndex) throw (Exception);
...
template <typename KeyType, typename ValueType>
unsigned int
IndexMap<KeyType, ValueType>::index(KeyType pKey) const throw (Exception)
{
...
template <typename KeyType, typename ValueType>
const KeyType&
IndexMap<KeyType, ValueType>::key(unsigned int pIndex) const throw (Exception)
{
...
template <typename KeyType, typename ValueType>
const ValueType&
IndexMap<KeyType, ValueType>::value(unsigned int pIndex) const throw (Exception)
{
...
template <typename KeyType, typename ValueType>
ValueType&
IndexMap<KeyType, ValueType>::value(unsigned int pIndex) throw (Exception)
{
    if(pIndex >= mValueVector.size()) throw(Exception( "DATA ERROR: index " + std::to_string(pIndex) + " exceeds size of IndexMap " + std::to_string(mValueVector.size()), __FILE__, __FUNCTION__, __LINE__ ));
    return mValueVector[pIndex];
}
...
template <typename KeyType, typename ValueType>
const ValueType&
IndexMap<KeyType, ValueType>::operator[] (unsigned int pIndex) const throw (Exception)
{
    if(pIndex >= mValueVector.size()) throw(Exception( "DATA ERROR: index " + std::to_string(pIndex) + " exceeds size of IndexMap " + std::to_string(mValueVector.size()), __FILE__, __FUNCTION__, __LINE__ ));
    return mValueVector[pIndex];
}
...
template <typename KeyType, typename ValueType>
ValueType&
IndexMap<KeyType, ValueType>::operator[] (unsigned int pIndex) throw (Exception)
{
    if(pIndex >= mValueVector.size()) throw(Exception( "DATA ERROR: index " + std::to_string(pIndex) + " exceeds size of IndexMap " + std::to_string(mValueVector.size()), __FILE__, __FUNCTION__, __LINE__ ));
    return mValueVector[pIndex];
}
...
template <typename KeyType, typename ValueType>
const ValueType&
IndexMap<KeyType, ValueType>::operator[] (const KeyType& pKey) const throw (Exception)
{
...
template <typename KeyType, typename ValueType>
ValueType&
IndexMap<KeyType, ValueType>::operator[] (const KeyType& pKey) throw (Exception)
{
    if(mMap.find(pKey) == mMap.end()) throw(Exception( "DATA ERROR: map key "  + Value<KeyType>(pKey).info() +  " not found", __FILE__, __FUNCTION__, __LINE__ ));
    return mMap[pKey];
}
...
template <typename KeyType, typename ValueType>
void
IndexMap<KeyType, ValueType>::add(const KeyType& pKey, const ValueType& pValue) throw (Exception)
{
...
template <typename KeyType, typename ValueType>
void
IndexMap<KeyType, ValueType>::insert(const KeyType& pKey, const ValueType& pValue) throw (Exception)
{
    if(mMap.find(pKey) != mMap.end()) throw(Exception( "DATA ERROR: map key "  + Value<KeyType>(pKey).info() +  " already stored", __FILE__, __FUNCTION__, __LINE__ ));
...
template <typename KeyType, typename ValueType>
void
IndexMap<KeyType, ValueType>::insert(const KeyType& pKey, const ValueType& pValue, unsigned int pIndex ) throw (Exception)
{
    if(mMap.find(pKey) != mMap.end()) throw(Exception( "DATA ERROR: map key "  + Value<KeyType>(pKey).info() +  " already stored", __FILE__, __FUNCTION__, __LINE__ ));
    if(pIndex >= mValueVector.size()) throw(Exception( "DATA ERROR: index " + std::to_string(pIndex) + " exceeds size of IndexMap " + std::to_string(mValueVector.size()), __FILE__, __FUNCTION__, __LINE__ ));
...
template <typename KeyType, typename ValueType>
void
IndexMap<KeyType, ValueType>::move(unsigned int pFromIndex, unsigned int pToIndex) throw (Exception)
{
...
template <typename KeyType, typename ValueType>
void
IndexMap<KeyType, ValueType>::replace(const KeyType& pKey, const ValueType& pValue) throw (Exception)
{
    if(mMap.find(pKey) == mMap.end()) throw(Exception( "DATA ERROR: map key "  + Value<KeyType>(pKey).info() +  " not found", __FILE__, __FUNCTION__, __LINE__ ));
...
template <typename KeyType, typename ValueType>
void
IndexMap<KeyType, ValueType>::replace(unsigned int pIndex, const ValueType& pValue) throw (Exception)
{
    if(pIndex >= mValueVector.size()) throw(Exception( "DATA ERROR: index " + std::to_string(pIndex) + " exceeds size of IndexMap " + std::to_string(mValueVector.size()), __FILE__, __FUNCTION__, __LINE__ ));
...
template <typename KeyType, typename ValueType>
void
IndexMap<KeyType, ValueType>::set(const KeyType& pKey, const ValueType& pValue) throw (Exception)
{
    try
    {
...
template <typename KeyType, typename ValueType>
void
IndexMap<KeyType, ValueType>::set(unsigned int pIndex, const ValueType& pValue) throw (Exception)
{
    if(pIndex >= mValueVector.size()) throw(Exception( "DATA ERROR: index " + std::to_string(pIndex) + " exceeds size of IndexMap " + std::to_string(mValueVector.size()), __FILE__, __FUNCTION__, __LINE__ ));
...
template <typename KeyType, typename ValueType>
void
IndexMap<KeyType, ValueType>::remove(const KeyType& pKey) throw (Exception)
{
    if(mMap.find(pKey) == mMap.end()) throw(Exception( "DATA ERROR: map key "  + Value<KeyType>(pKey).info() +  " not found", __FILE__, __FUNCTION__, __LINE__ ));
...
template <typename KeyType, typename ValueType>
void
IndexMap<KeyType, ValueType>::remove(unsigned int pIndex) throw (Exception)
{
    if(pIndex >= mValueVector.size()) throw(Exception( "DATA ERROR: index " + std::to_string(pIndex) + " exceeds size of IndexMap " + std::to_string(mValueVector.size()), __FILE__, __FUNCTION__, __LINE__ ));
