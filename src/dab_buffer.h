...
public:
    ...
    virtual const _Buffer& operator=( const _Buffer& pBuffer ) throw (Exception) = 0;
...
public:
    ...
    const _Buffer& operator=( const _Buffer& pBuffer ) throw (Exception);
...
template< typename Type >
const _Buffer&
Buffer< Type >::operator=(const _Buffer& pBuffer) throw (Exception)
{
