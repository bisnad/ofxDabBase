...
void
FileIO::write( const std::string& pString, const std::string& pFileName ) throw (Exception)
{
...
void
FileIO::read( const std::string& pFileName, std::string& pString ) throw (Exception)
{
